package com.dimas.compose.booksurfer.book.presentation.book_list.components
...
import com.dimas.compose.booksurfer.core.presentation.ui.theme.LightBlue
    ...
    Surface(
        ...
        Row(
                ...
                when (val result = imageLoadResult) {
                    null -> CircularProgressIndicator()
                        ...
                        Image(
                            ...
                            else painterResource(R.drawable.book_error_2),
            ...
            Column(
                ...
                book.ratingsAverage?.let { rating ->
                    Row(
                        verticalAlignment = Alignment.CenterVertically
                    ) {
                        Text(
