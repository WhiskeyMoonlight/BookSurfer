...
import com.dimas.compose.booksurfer.core.data.safeCall
            ...
            httpClient.get(
                ...
                parameter(
                    "fields", "key,title,language,cover_i,author_key," +
                            "author_name,cover_edition_key,first_publish_year,ratings_average," +
                            "ratings_count,number_of_pages_median,edition_count"
                )
            }
        }
    }
